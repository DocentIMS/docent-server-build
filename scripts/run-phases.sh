...
echo "        DNS on the IPv4 address. No support ticket needed."
echo "        Without PTR, outbound mail to Gmail/Outlook lands in spam."
echo "    [ ] After PTR is set, test root alias delivery:"
...
echo "    [ ] From your own computer (not this server), run these three lines:"
echo "          ${BOLD}ssh -p 2222 wayne@66.55.78.148${RESET}"
echo "          ${BOLD}cd /home/wayne/server-build/scripts${RESET}"
echo "          ${BOLD}./phase8-monitoring.sh ${DOMAIN}${RESET}"
echo "        Creates 6 monitors (WordPress, Plone, Roundcube, SMTP, submission, IMAPS)"
...
echo "${BOLD}${YELLOW}============================================================${RESET}"
echo ""
echo "  Enable UptimeRobot monitoring for this tenant."
echo "  From your own computer (not this server), copy-paste these"
echo "  three lines:"
echo ""
echo "    ${BOLD}ssh -p 2222 wayne@66.55.78.148${RESET}"
echo "    ${BOLD}cd /home/wayne/server-build/scripts${RESET}"

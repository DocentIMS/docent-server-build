...
echo "    [ ] From your own computer (not this server), paste this one line:"
echo "          ${BOLD}ssh -p 2222 wayne@66.55.78.148 -t 'cd /home/wayne/server-build/scripts && ./phase8-monitoring.sh ${DOMAIN}'${RESET}"
